...
#define OMEMO_INTERNAL_HEADER_MAXSIZE        (2 + 2 * 6 + 34 + 2)
#define OMEMO_INTERNAL_FULLMSG_MAXSIZE                                 \
  (OMEMO_INTERNAL_HEADER_MAXSIZE +                            \
   OMEMO_INTERNAL_PAYLOAD_MAXPADDEDSIZE)
#define OMEMO_INTERNAL_PREKEYHEADER_MAXSIZE (6 * 2 + 34 * 2 + 3)
#define OMEMO_INTERNAL_ENCRYPTED_MAXSIZE                               \
  (2 + 16 + OMEMO_INTERNAL_FULLMSG_MAXSIZE)
#else
...
#define OMEMO_INTERNAL_FULLMSG_MAXSIZE                                 \
  (1 + OMEMO_INTERNAL_HEADER_MAXSIZE +                                 \
   OMEMO_INTERNAL_PAYLOAD_MAXPADDEDSIZE)
